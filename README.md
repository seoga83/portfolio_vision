...
---
## portfolio 1. 게임 등에서 방향 컨트롤러로 활용 가능한 제스처 분류
### 1. 프로젝트 개요
> 1.1 프로젝트 주제
> * 별도의 콘트롤러 없이 사람의 손동작이나 눈동자 움직임으로 방향을 결정할 수 있는 방안 마련
> * 적은 수의 데이터셋에도 높은 성능을 보일 수 있는 분류 모델

> 1.2 프로젝트 배경
> * 게임이나 전자기기의 작동을 위한 좀 더 편한 접근 방식에 대한 연구 활발
> * 인공지능 기술을 활용하여 장비에 독립적인 방안..... 
